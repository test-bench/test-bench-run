    ...
    context "File Summary" do
      context "Aborted" do
        ...
        context "Styling Enabled" do
          ...
          \e[31m\e[2m-\e[22m \e[1m#{file_info.file_path}\e[22m: 11+ skipped, 1 error:\e[m
            \e[31m#{aborted.message}\e[m
            \e[31m#{aborted.location}\e[m
          \e[m
        ...
        context "Styling Disabled" do
          ...
          File Summary
          - - -
          - #{file_info.file_path}: 11+ skipped, 1 error:
            #{aborted.message}
            #{aborted.location}
